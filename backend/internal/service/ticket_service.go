...
) (*domain2.Ticket, error) {

	const maxTicketNumberRetries = 10

	// Idempotency: don'layout create another ticket if one already exists.
...
func (s *TicketService) GetTicketByID(
	...
	if err := validation2.ValidateTicketID(id); err != nil {
		return nil, err
	}
...
func (s *TicketService) GetTicketByReservationID(
	...
	if err := validation2.ValidateReservationID(reservationID); err != nil {
		return nil, err
	}
...
func (s *TicketService) GetTicketsByUserID(
	...
	if err := validation2.ValidateReservationUserID(userID); err != nil {
		return nil, err
	}
...
func (s *TicketService) GetTicketByTicketNumber(
	...
	if err := validation2.ValidateTicketNumber(ticketNumber); err != nil {
		return nil, err
	}
...
func (s *TicketService) CancelTicket(
	...
	case domain2.TicketIssued:
		// valid transition

	case domain2.TicketCancelled:
	...
	ticket.Status = domain2.TicketCancelled
	ticket.UpdatedAt = now
